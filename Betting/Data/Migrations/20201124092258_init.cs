        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GameId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AwayTeamBetRate = table.Column<float>(nullable: false),
                    AwayTeamGoals = table.Column<int>(nullable: false),
                    AwayTeamId = table.Column<int>(nullable: false),
                    DrawBetRate = table.Column<float>(nullable: false),
                    HomeTeamBetRate = table.Column<float>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinutesPlayed = table.Column<float>(nullable: false),
